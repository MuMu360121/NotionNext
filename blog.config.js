...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'e51ddcc979a84ef4a96a70335b4ce376',//en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '木木公子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '木木不吃糖', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.manyfun.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,AI,技术分享,博客', // 网站关键词 英文逗号隔开
